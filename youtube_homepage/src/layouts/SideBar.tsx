import {Home, Repeat, Clapperboard, Library, ChevronUp, ChevronDown,PlaySquare,Clock, History, ListVideo, Flame, ShoppingBag, Music2, Film, Radio, Gamepad2, Newspaper, Trophy, Lightbulb, Shirt, Podcast } from 'lucide-react'
